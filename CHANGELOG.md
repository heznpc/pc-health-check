...
### Security
- **CodeQL restored for the public repository.** Actions, JavaScript/TypeScript, and Python use build-free analysis while Swift uses an explicit nested SwiftPM build instead of the incompatible default Xcode autobuilder.
